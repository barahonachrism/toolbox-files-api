...
describe('======Collection of Unit Test for Files API ToolBox======', function () {
  describe('Parse csv files: ', function () {
    ...
    it('Process file test case ok', function () {
      ...
      const spectedResult = '{"fileName":"test3.csv","lines":[{"text":"iWIoiilHdlDaPhgwGVDjBajhOFR","number":66332912,"hex":"d36546505e7e518bac4417be7b359ab0"},{"text":"OpiTbumymMqgAHNbLvlUhQVcstx","number":52143,"hex":"44ea3798fabd921c567a7fd2d4a4731c"},{"text":"jJLRLQHuEJcHb","number":1557652439,"hex":"59e7a2af6cf1085464aa50b10ce599b1"}]}'

      const result = processFile(fileData)
    ...
    it('Process file test empty response', function () {
      const fileData = 'file,text,number,hex'
      const result = processFile('test4.csv', fileData)
      chai.assert.isNull(result)
    })
